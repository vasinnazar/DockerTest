...
class LoanType extends Model
{
    ...
    protected $fillable = [
        ...
        'additional_contract_perm_id',
        'perm_contract_form_id',
        'perm_card_contract_form_id',
        'additional_card_contract_id',
        'additional_card_contract_perm_id',
        'terminal_promo_discount',
        'has_special_pc_for_dop',
        'min_time',
        'min_money',
        'data',
    ];
