...
class DebtorsController extends BasicController
{
     ...
     * @return type
     */
    public function debtorcard(DebtorSmsRepository $smsRepository, PaysClient $paysClient,int $debtor_id)
    {
        $user = auth()->user();
...
//            $planEvent->id_1c = DebtorEvent::getNextNumber();
     ...
     */
    public function sendSmsToDebtor(DebtorSmsRepository $smsRepository,DebtorSmsService $service,Request $req)
    {
        ...
        $sms = $req->sms_id ? $smsRepository->firstById((int)$req->sms_id) : null;
