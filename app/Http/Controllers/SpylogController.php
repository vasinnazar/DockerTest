...
class SpylogController extends Controller {
    ...
    public function getList(Request $request) {
        $cols = ['logs.created_at as log_created_at', 'users.name as username',
            'logs.table_id as log_table', 'logs.doc_id as log_doc_id',
            'logs.action as log_action', 'logs.id as log_id',
