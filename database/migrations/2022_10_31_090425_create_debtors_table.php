...
class CreateDebtorsTable extends Migration
{
    ...
    public function up()
    {
        Schema::connection('debtors')->create('debtors', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->integer('overpayments')->nullable()->default(0);
            ...
            $table->integer('is_bigmoney')->default(0);
            $table->integer('is_pledge')->default(0);
            $table->integer('is_pos')->default(0);
            $table->integer('od_after_closing')->nullable();
            $table->timestamp('closed_at')->nullable();
            $table->integer('sale_status')->nullable()->default(0);

            $table->index(['passport_series', 'passport_number'], 'IDX_passports_numbers');
    ...
    {
        Schema::connection('debtors')->dropIfExists('debtors');
    }
}
