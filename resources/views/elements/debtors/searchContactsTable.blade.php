<table class='table table-bordered table-condensed'>
    ...
    @if ($collectContacts->get('equal_addresses_register_to_register', false))
        <tr>
            <td colspan="8" style="background: #5bc0de;">Совпадение адресов прописки</td>
        </tr>
        @if (!$collectContacts->get('equal_addresses_register_to_register')->count())
            <tr>
                <td colspan="8">Совпадений по адресу прописки не найдено.</td>
            </tr>
        @else
    ...
    @if ($collectContacts->get('equal_addresses_register_to_fact', false))
        <tr>
            <td colspan="8" style="background: #5bc0de;">Совпадение адреса прописки с адресом проживания</td>
        </tr>
        @if (!$collectContacts->get('equal_addresses_register_to_fact')->count())
            <tr>
                <td colspan="8">Совпадений по адресу прописки с адресом проживания не найдено.</td>
            </tr>
        @else
    ...
    @if ($collectContacts->get('equal_addresses_fact_to_register', false))
        <tr>
            <td colspan="8" style="background: #5bc0de;">Совпадение адреса проживания с адресом прописки</td>
        </tr>
        @if (!$collectContacts->get('equal_addresses_fact_to_register')->count())
            <tr>
                <td colspan="8">Совпадений по адресу проживания с адресом прописки не найдено.</td>
            </tr>
        @else
    ...
    @if ($collectContacts->get('equal_addresses_fact_to_fact', false))
        <tr>
            <td colspan="8" style="background: #5bc0de;">Совпадение адресов проживания</td>
        </tr>
        @if (!$collectContacts->get('equal_addresses_fact_to_fact')->count())
            <tr>
                <td colspan="8">Совпадений по адресу проживания не найдено.</td>
            </tr>
        @else
