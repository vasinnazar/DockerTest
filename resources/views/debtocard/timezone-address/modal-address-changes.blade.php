                ...
                <div class="row">
                    ...
                    <form id="addressCustomer">
                        ...
                        <div class="col-sm-6">
                            ...
                            <label>Район</label>
                            <input type="text" class="form-control" id="fact_address_district" name="fact_address_district"
                            ...
                            <label>Корпус</label>
                            <input type="text" class="form-control" id="fact_address_building" name="fact_address_building"
                                   value="{{$debtor->passport->fact_address_building}}" disabled>
                            <label>Квартира</label>
                            <input type="text" class="form-control" id="fact_address_apartment" name="fact_address_apartment"
