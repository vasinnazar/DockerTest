		...
		if(result == false)
		{
			imgList.find('li').each(function() {
				...
				new uploaderObject({
					...
					token: $(".regForm input[name=_token]").val(),
...
var uploaderObject = function(params) {
    ...
    self.reader.onload = function() {
        ...
        var body = "--" + boundary + "\r\n";
        body += "Content-Disposition: form-data; name='"+(params.fieldName || 'file')+"'; _token='"+ params.token +"'; filename='" + params.file.name + "'\r\n";
